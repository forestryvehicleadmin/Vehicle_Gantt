...
custom_colors = [
    "#350808","#470A34","#3D0C5A","#0E136C","#10617F","#11925C","#21A512","#95B913","#093508","#35470A","#5A3C0C","#6C0E13","#7F1061","#5C1192","#1221A5","#1395B9","#080935","#0A3547","#0C5A3C","#146C0E","#637F10","#925A11","#A51221","#B91395"
]
...
with st.expander("Manage Entries (Create, Edit, Delete) VEM use only."):
    ...
    if passcode == "1234":  # Replace with your secure passcode
        ...
        new_entry["Type"] = st.radio("Type (Vehicle):", options= type_list)
