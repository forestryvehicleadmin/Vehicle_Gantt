...
def main():
    ...
    if st.session_state.authenticated:
        ...
        with tab3:
            ...
            edit_id = st.selectbox("Select Entry", df["Unique ID"].tolist(), format_func=fmt)
        ...
        # --- TAB 4: DELETE ---
        with tab4:
            del_id = st.selectbox("Select Entry to Delete", df["Unique ID"].tolist(), format_func=fmt, key="del_sel")
